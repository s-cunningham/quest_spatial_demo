...
Analysis Tab \> Raster Functions \> Surface \> Hillshade

![](images/Screenshot 2025-03-20 110756.png)
...
The 3rd and 4th arguments we included, `angle` and `direction` are the elevation angle of the light source (i.e., the sun), in degrees, and the direction of the light source, also in degrees. Try changing these values to see how the hillshade changes. These are slightly different than the parameters in ArcGIS Pro (azimuth & height)

You can save the hillshade directly by adding the `filename` argument.
